...
fun SectionHeader(
    ...
    Box(
        ...
        Column(
            ...
            SpanText(
                modifier = Modifier
                    .fontSize(if (breakpoint >= Breakpoint.MD) 82.px else 54.px)
                    .lineHeight(if (breakpoint >= Breakpoint.MD) 82.px else 48.px)
            ...
            Row(
                ...
                Box(
                    modifier = Modifier
                        .height(if (breakpoint >= Breakpoint.MD) 60.px else 34.px)
                ...
                SpanText(
                    modifier = Modifier
                        .margin(left = 10.px)
                        .fontSize(if (breakpoint >= Breakpoint.MD) 34.px else 20.px)
                        .lineHeight(if (breakpoint >= Breakpoint.MD) 36.px else 22.px)
                        .color(Color.white),
                    text = subtitle
                )
            }
